...
export const INITIAL_TELEGRAM_PROXIES: TelegramProxyItem[] = [
  { id: 'tg_mt_1', title: 'MTProto • zone', server: 'zone.lovely.lat', port: 443, secret: 'eeaadd88aa9facd454936d0c42dc128e777a6f6e652e6c6f76656c792e6c6174', ping: null, status: 'untested', sponsorChannel: '@ProxyMTProto', country: 'عمومی (MTProto)', countryCode: 'TG', flag: '🔐', type: 'mtproto', protocolDetails: 'TLS 1.3 Fake TLS (Secure)' },
  { id: 'tg_mt_2', title: 'MTProto • max', server: 'max.kimt.click', port: 443, secret: 'ee1b153cf06dbd43c6085c359a6702eb936d61782e6b696d742e636c69636b', ping: null, status: 'untested', sponsorChannel: '@ProxyMTProto', country: 'عمومی (MTProto)', countryCode: 'TG', flag: '🔐', type: 'mtproto', protocolDetails: 'TLS 1.3 Fake TLS (Secure)' },
  { id: 'tg_mt_3', title: 'MTProto • as', server: 'as.mkim.click', port: 443, secret: 'ee2dfa3526fc70b7abd7a09eade6ccea1f61732e6d6b696d2e636c69636b', ping: null, status: 'untested', sponsorChannel: '@ProxyMTProto', country: 'عمومی (MTProto)', countryCode: 'TG', flag: '🔐', type: 'mtproto', protocolDetails: 'TLS 1.3 Fake TLS (Secure)' },
  { id: 'tg_mt_4', title: 'MTProto • mkima', server: 'mkima.davay.click', port: 443, secret: 'ee39300be14c4d54704c92416d555fa7026d6b696d612e64617661792e636c69636b', ping: null, status: 'untested', sponsorChannel: '@ProxyMTProto', country: 'عمومی (MTProto)', countryCode: 'TG', flag: '🔐', type: 'mtproto', protocolDetails: 'TLS 1.3 Fake TLS (Secure)' },
  { id: 'tg_mt_5', title: 'MTProto • 194.59.221.90', server: '194.59.221.90', port: 8444, secret: 'ee7577a125c7ad9c1d711adb2ebd0f6efc6465636174686c6f6e2e636f6d', ping: null, status: 'untested', sponsorChannel: '@ProxyMTProto', country: 'عمومی (MTProto)', countryCode: 'TG', flag: '🔐', type: 'mtproto', protocolDetails: 'TLS 1.3 Fake TLS (Secure)' },
  { id: 'tg_mt_6', title: 'MTProto • 194.59.221.90', server: '194.59.221.90', port: 8443, secret: 'eef4b79908a669cfe8f293941da4e388916465636174686c6f6e2e636f6d', ping: null, status: 'untested', sponsorChannel: '@ProxyMTProto', country: 'عمومی (MTProto)', countryCode: 'TG', flag: '🔐', type: 'mtproto', protocolDetails: 'TLS 1.3 Fake TLS (Secure)' },
  { id: 'tg_mt_7', title: 'MTProto • portal', server: 'portal.mtproxy.cc', port: 443, secret: 'eeef7017f26c9ecb71ed8d760999294318786170692e6f7a6f6e2e7275', ping: null, status: 'untested', sponsorChannel: '@ProxyMTProto', country: 'عمومی (MTProto)', countryCode: 'TG', flag: '🔐', type: 'mtproto', protocolDetails: 'TLS 1.3 Fake TLS (Secure)' },
  { id: 'tg_mt_8', title: 'MTProto • 94.130.94.122', server: '94.130.94.122', port: 8443, secret: '104462821249bd7ac519130220c25d09', ping: null, status: 'untested', sponsorChannel: '@dicodeir', country: 'عمومی (MTProto)', countryCode: 'TG', flag: '🔐', type: 'mtproto', protocolDetails: 'TLS 1.3 Fake TLS (Secure)' },
];
